...
| `update-coding-agents` | `shared/.local/bin/update-coding-agents` | Check, update, and schedule updates for configured coding-agent CLIs and tools, including CodeGraph and RTK. | `update-coding-agents --help` |
